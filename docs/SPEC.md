...
1. **Ensures Docker daemon is running** - Checks via `docker info`
...
| "Claude Code process exited with code 1" | Docker not running | Check `docker info`; ensure Docker daemon is started |
